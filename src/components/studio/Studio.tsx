    ...
    >
      ...
      <Reveal className="grid md:grid-cols-2 gap-12 items-end mb-14">
        ...
        <p className="max-w-[42ch] text-[15px] text-white/75 font-sans font-light">
          Choose hues from our curated palettes or bring your own. Adjust the mix, the depth, the
          grain — everything re-renders instantly. When it feels right, export for your device.
        </p>
      </Reveal>
